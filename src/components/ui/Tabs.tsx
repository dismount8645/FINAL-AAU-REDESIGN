      ...
      {items.map((tab, i) => {
        ...
        return (
          <button
            ...
            className={`relative flex items-center px-md py-sm cursor-pointer transition-all duration-200 font-bold text-sm whitespace-nowrap outline-none focus-visible:outline-none focus-visible:shadow-focus focus-visible:bg-bg-hover before:absolute before:top-1/2 before:left-1/2 before:min-h-[44px] before:min-w-[44px] before:w-full before:h-full before:-translate-x-1/2 before:-translate-y-1/2 before:content-[''] ${isActive ? 'text-primary' : 'text-muted hover:text-main dark:text-white/60 dark:hover:text-white'}`}
